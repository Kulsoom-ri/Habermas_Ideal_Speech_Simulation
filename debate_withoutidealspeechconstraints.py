...
WITHOUT CONSTRAINTS OF IDEAL SPEECH SITUATION
================================================================
...
This is a copy of debate.py with the only difference being that ideal speech constraints
are removed.
"""
...
class DebateAgent:
    ...
    def construct_system_prompt(self) -> str:
        ...
        return f"""You are {self.name}, a participant in a debate.
"""
...
def main():
    ...
    # Save transcript
    simulator.save_transcript("debatewithoutconstraints_transcript_10.txt")
